...
class WHrecType extends AbstractType
{
    protected $em;
    protected $user;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('packages', 'collection', array('mapped' => true, 'required' => false, 'label' => false, 
                'type' => new PackageType($carriers), 'allow_add' => true, 'allow_delete' => true, 'by_reference' => false,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
       $resolver->setDefaults(array(
            'data_class' => 'NvCarga\Bundle\Entity\WHrec'
        ));
    }
